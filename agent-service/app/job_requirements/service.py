...
from app.job_requirements.repositories import JobRequirementRepository
from app.job_requirements.schemas import JobRequirementResponse, JobRequirementSummary
